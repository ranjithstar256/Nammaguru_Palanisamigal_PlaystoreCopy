...
public class Recent_Update_Adapter extends RecyclerView.Adapter<Recent_Update_Adapter.ViewHolder> {
    ...
    public Recent_Update_Adapter(Context context) {

        this.context = context;

    }

    public void setOnClickListener(RecentList recentList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.activity_recentupdates_items, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        holder.card_view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                recentList.onCityClickListener(v,position,items,upcoming_list_models);
            }
        });
